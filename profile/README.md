...
This should have all of the neccesary libraries in order to build an entertaining and interesant server. Players won't need a mod to play (a client side mod could also be created for more indepth gameplay).
